export class Constants {
    ...
    public static UNVERIFIED_EMAIL = 'Email is not verified! Please check your inbox';
    public static WRONG_MESSAGE = 'Something went wrong!';
    public static VERIFY_EMAIL = 'The link has been sent to your registered email, please check it!';
    public static MESSAGE_NOT_SENT = 'Something went wrong, the mail could not be sent to your email'; 
